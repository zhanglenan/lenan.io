  ...
  <tr>
    ...
    <td valign="top" bgcolor="#FFFFFF">
      <table width="100%" height="60"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="62%">&nbsp;</td>
          <td width="38%"><div align="center"><img src="images/tit1.gif" width="314" height="34" /></div></td>
        </tr>
      </table>
      <table width="97%" height="422"  border="0" align="center" cellpadding="10" cellspacing="0" bordercolor="#FEFEFE" bgcolor="#8F8F8F">
        <tr>
          <td height="184" valign="top" bgcolor="#FFFFFF"><p class="xtitle">Electrical Discharge Machining (EDM): </p>
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="1" bgcolor="#8F8F8F"></td>
              </tr>
            </table>
            <table width="948"  border="0" align="center" cellpadding="10" cellspacing="1" bordercolor="#FEFEFE" bgcolor="#8F8F8F">
            <tr>
              <td bgcolor="#FFFFFF"><p class="zoom">
                <span class="box_list">
                <%Call Ok3w_Article_List(1,5,1,100,False,False,False,"",False,"")%>
                </span>              </p>                </td>
            </tr>
          </table>
          <p class="xtitle">Lattice Boltzmann Method (LBM): </p>
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="1" bgcolor="#8F8F8F"></td>
            </tr>
          ...
          <table width="948"  border="0" align="center" cellpadding="10" cellspacing="1" bordercolor="#FEFEFE" bgcolor="#8F8F8F">
            <tr>
              <td bgcolor="#FFFFFF"><p class="zoom"> <span class="box_list">
                  <%Call Ok3w_Article_List(2,5,1,100,False,False,False,"",False,"")%>
              </span> </p></td>
            </tr>
          </table>          <p class="xtitle">Laser chemical vapor deposition: </p> 
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="1" bgcolor="#8F8F8F"></td>
            </tr>
          ...
          <table width="948"  border="0" align="center" cellpadding="10" cellspacing="1" bordercolor="#FEFEFE" bgcolor="#8F8F8F">
            <tr>
              <td bgcolor="#FFFFFF"><p class="zoom"> <span class="box_list">
                  <%Call Ok3w_Article_List(3,5,1,100,False,False,False,"",False,"")%>
              </span> </p></td>
            </tr>
          </table></td>
        </tr>

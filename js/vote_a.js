...
document.write('<form id="form_mood" name="form_mood" method="post" action="./c/mood.asp?action=mood&ID='+ArticleID+'" target="iframe_mood">');
...
document.write('</tr>');
document.write('<tr>');
document.write('  <td height="50" align="center" style="cursor:pointer;" onClick="s_mood(1)" title="点击投票"><img src="./images/mood/1.gif" width="40" height="40" /></td>');
document.write('  <td align="center" style="cursor:pointer;" onClick="s_mood(2)" title="点击投票"><img src="./images/mood/2.gif" width="40" height="40" /></td>');
document.write('  <td align="center" style="cursor:pointer;" onClick="s_mood(3)" title="点击投票"><img src="./images/mood/3.gif" width="40" height="40" /></td>');
document.write('  <td align="center" style="cursor:pointer;" onClick="s_mood(4)" title="点击投票"><img src="./images/mood/4.gif" width="40" height="40" /></td>');
document.write('  <td align="center" style="cursor:pointer;" onClick="s_mood(5)" title="点击投票"><img src="./images/mood/5.gif" width="40" height="40" /></td>');
document.write('  <td align="center" style="cursor:pointer;" onClick="s_mood(6)" title="点击投票"><img src="./images/mood/6.gif" width="40" height="40" /></td>');
document.write('  <td align="center" style="cursor:pointer;" onClick="s_mood(7)" title="点击投票"><img src="./images/mood/7.gif" width="40" height="40" /></td>');
document.write('  <td align="center" style="cursor:pointer;" onClick="s_mood(8)" title="点击投票"><img src="./images/mood/8.gif" width="40" height="40" /></td>');
document.write('</tr>');
document.write('<tr>');
...
document.write('<iframe id="iframe_mood" name="iframe_mood" src="./c/mood.asp?ID='+ArticleID+'&action=" style="display:none;"></iframe>');
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder">
  ...
  <tr>
	...
	<br>
	<p align="center">欢迎使用采集系统，使用数据库管理功能之前请阅读此说明。</p>
	<p>
...
%>
   ...
   <tr class="tdbg">
      ...
      导出到数据库：<input type="text" name="LeadOutMdb" size="30" value="Databackup/Ok3w_Item.asp">
...
Sub LeadOutData
   ...
   If FoundErr<>True And ObjInstalled<>False Then
      ...
      Else
         ...
         Else
            FoundErr=True
            ErrMsg=ErrMsg& "<br>用于导出项目的数据库：ItemTemp.asp不存在！"
         End If
      End If
      set fso=nothing
   End If

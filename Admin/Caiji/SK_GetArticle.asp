...
<form method="post" action="SK_getArticle.asp" name="myform" onSubmit="return CheckForm();">
    ...
    <tr class="tdbg">
      ...
      手动添加 <input type="radio" value="3" name="ListPaingType" <% if ListPaingType=3 then Response.Write "checked" %> onClick="ListPaing2.style.display='none';ListPaing3.style.display='none';ListPaing4.style.display=''">
      代码获取</td>
    </tr>

...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder">
  <tr class="tdbg"> 
    ...
    <td height="30"><a href="sk_class.asp?action=add&Colleclx=<%=Colleclx%>">从Ok3w新闻系统中导入分类</a></td>
  </tr>
</table>
<% 
...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder" >
    <tr> 
      <th height="22" colspan="2" class="title"> <div align="center"><b>分类&nbsp;管&nbsp;理</b></div></th>
    </tr>
    <tr>
...
<div align="center"> <%=ErrMsg%>
  <input type="submit" name="Submit" value="点这里，重新导入分类（现在分类将清空）" onClick="if(!confirm('真的要重新导入吗？')) return false;">
</div>
  </form>
<% end sub %>

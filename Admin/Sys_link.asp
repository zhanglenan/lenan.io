                ...
                valign="top" bgcolor="#fffcf7">
				      <table width="100%" border="0" cellpadding="8" cellspacing="1" bgcolor="#CCCCCC">
                        ...
                        <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#EFEFEF';" onMouseOut="this.style.backgroundColor='#FFFFFF';">
                          <td><input name="Lname" type="text" id="Lname" size="15" /></td>
                          <td><input name="Lurl" type="text" id="Lurl" size="20" /></td>
                          <td><input name="Lpic" type="text" id="Lpic" size="20" /></td>
                          <td><input name="Ltype" type="checkbox" id="Ltype" value="1">启用</td>
                          <td><input name="Ctype" type="radio" value="1" checked>
                            新闻
                              <input type="radio" name="Ctype" value="2">
                              软件</td>
                          <td><input name="Lorder" type="text" id="Lorder" value="<%=Link.GetMaxOrder()+1%>" size="2" /></td>
                          <td><input name="Lnote" type="hidden" id="Lnote">
...
%>						<form name="form2" method="post" action="">
                        <tr bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#EFEFEF';" onMouseOut="this.style.backgroundColor='#FFFFFF';">
                          <td><input name="Lname" type="text" id="Lname" value="<%=Rs("Lname")%>" size="15" /></td>
                          <td><input name="Lurl" type="text" id="Lurl" value="<%=Rs("Lurl")%>" size="20" /></td>
                          <td><input name="Lpic" type="text" id="Lpic" value="<%=Rs("Lpic")%>" size="20" /></td>
                          <td><input name="Ltype" type="checkbox" id="Ltype" value="1" <%If Rs("Ltype")=1 Then%>checked<%End If%>>启用</td>
                          <td><input name="Ctype" type="radio" value="1" <%If Rs("Ctype")=1 Then%>checked<%End If%>>
新闻
  <input type="radio" name="Ctype" value="2" <%If Rs("Ctype")=2 Then%>checked<%End If%>>
软件</td>
                          <td><input name="Lorder" type="text" id="Lorder" value="<%=Rs("Lorder")%>" size="2" /></td>
                          <td><input name="Lnote" type="hidden" id="Lnote" value="<%=Rs("Lnote")%>">

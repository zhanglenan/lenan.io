	...
	%>
                          <tr>
                            <td height="25" align="center" bgcolor="#FFFFFF">
                              <textarea name="textarea" cols="35" rows="6">姓名：<%= Rs("UserName")%>
标题：<%= Rs("Title")%>
邮箱：<%= Rs("Mail")%>
主页：<%= Rs("Homepage")%>
OICQ：<%= Rs("QQ")%>
...
IP：<%= Rs("Ip")%></textarea></td>
                            <td align="center" bgcolor="#FFFFFF"><textarea name="Content" cols="35" rows="6" id="Content"><%= Rs("Content")%></textarea></td>

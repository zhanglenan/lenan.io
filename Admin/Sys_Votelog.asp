...
%>
                        <tr>
                          <td height="25" align="center" bgcolor="#FFFFFF"><%=Rs("ID")%></td>
                          <td height="25" align="center" bgcolor="#FFFFFF"><%=Rs("pID")%></td>
                          <td height="25" align="center" bgcolor="#FFFFFF"><%=Rs("vID")%></td>
                          <td height="25" align="center" bgcolor="#FFFFFF"><%=Rs("vIP")%></td>
                          <td height="25" align="center" bgcolor="#FFFFFF"><%=Rs("vTime")%></td>
...
%>
                        ...
                        <tr>
                          <td height="25" colspan="6" align="right" bgcolor="#FFFFFF"><%Call Page.GetPageList()%>
                            &nbsp;</td>
                        </tr>
						</form>
                      </table>
